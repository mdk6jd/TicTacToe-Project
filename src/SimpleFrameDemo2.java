...
/*
 * This demo shows off the window decoration features added in
 * 1.4, plus some window positioning code and setIconImage. It uses
 * the file yellowBang.png (alt. file is shield.png). Images
 * stored in "images" folder.
 */
public class SimpleFrameDemo2 extends WindowAdapter
    ...
    public void showNewWindow() {
        ...
        if (specifyIcon) {
            if (createIcon) {
            	...
            	//get the stored icon (yellowBang.gif)
                frame.setIconImage(new ImageIcon("images/yellowBang.png").getImage());
                //frame.setIconImage(new ImageIcon("images/shield.png").getImage());
                //frame.setIconImage(getFDImage());  // not used
            }
        }
...
//        java.net.URL imgURL = SimpleFrameDemo2.class.getResource("images/FD.jpg");
//        if (imgURL != null) {
...
//    }
    ...
    private static void createAndShowGUI() {
        ...
        SimpleFrameDemo2 demo = new SimpleFrameDemo2();
